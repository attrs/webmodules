...
module.exports = function(options) {
  ...
  var node_modules_path = options.node_modules === false ? null : options.node_modules || path.join(cwd, 'node_modules');
  var web_modules_path = options.web_modules === false ? null : options.web_modules || rc.directory || path.join(cwd, 'web_modules');
