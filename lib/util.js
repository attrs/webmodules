...
module.exports = {
  ...
  extractPaths: (function() {
    var ignores = ['.', '..', 'npm-debug.log', 'node_modules', 'web_modules', '.DS_Store', '.git', '.gitignore', '.lock-wscript', '.hg', '.svn', 'CVS'];
    ...
    return function(basedir, excludes) {
      ...
      function visit(dir) {
        ...
        list.forEach(function(filename) {
          ...
          if( filename.startsWith('._') || filename.endsWith('.swp') || filename.startsWith('.wafpickle') ) return;
