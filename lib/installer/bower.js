...
module.exports = {
  install: function(pkg, options, done) {
    ...
    .on('end', function (installed) {
      ...
      manifest.web = bower_manifest.main || manifest.web || manifest.browser || manifest.main;
      manifest.webPeerDependencies = dependencies || manifest.webPeerDependencies;
